# mac-software-onekey
# 参考《给 Mac 优雅地一键「装机」》
https://sspai.com/post/43239

这篇文章将带给你优雅地一键「装机」的方式。

# 方法
> 利用 Homebrew 和 MAS 这两个工具来完成所有软件的自动安装；
后者能够操纵 Mac App Store 接口来安装其中的应用，而前者适用于非 MAS 的几乎所有软件。

这里给出我自己Mac的所有安装的软件，包括大部分**日常使用的软件和计算机专业的软件安装**；
并写成如下一串「装机」脚本，妥善保管好以上代码，需要用的时候只需要粘贴到终端，而不是去各个网站下载安装包。
